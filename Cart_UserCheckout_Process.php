...
// Fetch bought products from the database
$query_bought = "SELECT p.image, p.description, u.quantity, u.price, p.id AS product_id
...
<body>
    ...
    <?php while ($product = $result_bought->fetch_assoc()) {
        $total += $product['price'] * $product['quantity']; // Calculating total with quantity
    ?>
    <div class="item-info">
        ...
        <form method="POST" action="Partials/remove_users_bought_item.php" style="display:inline;">
